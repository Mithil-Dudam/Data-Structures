...
export default function Play() {
    ...
    const deleteElement = async () => {
        ...
        setError(null)
        setMessage(null)
        const response = await fetch("http://localhost:8000/sll/delete", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const deleteIndex = async () => {
        ...
        setError(null)
        setMessage(null)
        const response = await fetch("http://localhost:8000/sll/delete-index", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const searchElement = async () => {
        ...
        setError(null)
        setMessage(null)
        const response = await fetch("http://localhost:8000/sll/search", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const getLength = async () => {
        setError(null)
        setMessage(null)
        const response = await fetch("http://localhost:8000/sll/length", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
